...
namespace MyApi.Controllers
{
    ...
    public class OfficeController : ControllerBase
    {
        ...
        public OfficeOperation RentProcess { get; set; }
        public OfficeImgOperation RentImgProcess { get; set; }
        public Cloudinary cloudinary { get; set; }

        public OfficeController(Cloudinary cloudinaryNew, OfficeCustomerOperation officeCustomerOperation, OfficeOperation officeOperation, OfficeImgOperation officeImgOperation)
        {
            RentCustomerProcess = officeCustomerOperation;
            RentProcess = officeOperation;
        ...
        [HttpPost]
        public async void Add(Office rentHomeObject)
        {
            try
            {
        ...
        [Authorize]
        [HttpPost("Admin")]
        public async void AddOld(Office rentHomeObject)
        {
            try
            {
        ...
        [Authorize]
        [HttpPut]
        public async void Update([FromBody] Office entity)
        {
            try
            {
        ...
        [Authorize]
        [HttpPut("Recommend")]
        public async void UpdateRecommend([FromBody] Office sell)
        {
            try
            {
                ...
                if (items.Data.Count > 30)
                {
                    ...
                    var Sell30 = JsonSerializer.Deserialize<Office>(lastItem);
                    var LastId = await RentProcess.GetByIdListAdmin(Sell30.Id);
                    var LastIdString = JsonSerializer.Deserialize<Office>(JsonSerializer.Serialize(LastId.Data));
